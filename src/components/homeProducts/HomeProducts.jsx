            ...
            <div className='homeproducts'>
                <div className="homeproducts_boxs">
                    <div className="homeproducts_boxs_left">
                        <p style={{marginBottom:"30px"}} ><FaChevronLeft />
chegirmalar</p>
                    ...
                    <div className="homeproducts_boxs_right">
                        <div className="homeproducts_boxs_right_header">
                            <div className="homeproducts_boxs_right_header_text">
                                <p><AiFillStar style={{color:"eee"}} /> <FaStar style={{color:"eee"}} /> <FaStar style={{color:"eee"}} /> <FaStar style={{color:"eee"}} /> < FaStar style={{color:"eee"}} /> </p>
                                <p>Baholanmagan</p>
                            </div>
                            <h4>
                                {/* <AiOutlineHeart /> */}
                        ...
                        <b style={{padding:"5px 9px", marginBottom:"60px", backgroundColor:"rgb(255,68,68)", borderRadius:"20px"}} >-13%</b>
